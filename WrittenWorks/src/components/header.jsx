...
import { AppBar, Box, Button, IconButton, Toolbar, Tooltip, Typography, useMediaQuery } from '@material-ui/core';
...
export default ({ prop, children }) => {
	...
	let headerDynamicTitle = ((useMediaQuery("(min-width:670px)")) ? headerTitleQuery.site.siteMetadata.title : headerTitleQuery.site.siteMetadata.title_secondary);
	let headerDynamicAuthor = (useMediaQuery("(min-width:445px)") ? `| By ${headerTitleQuery.site.siteMetadata.author}` : "");
				...
				<AppBar position="absolute" color="primary">
					<Toolbar>
						...
						<Tooltip title="Toggle Dark / Light Mode" arrow>
							<IconButton edge="start" color="inherit" className={headerStyles.buttonModifiers} aria-label="theme-toggler">
								<FlareIcon />
							</IconButton>
						</Tooltip>
						<Tooltip title="Open Github Repo Of This Web App" arrow>
							<IconButton edge="start" color="inherit" target="__target" rel="noopener noreferrer"href="https://github.com/CodexLink/codexlink.github.io" className={headerStyles.buttonModifiers} aria-label="repo-redirector">
								<GitHubIcon />
							</IconButton>
						</Tooltip>
						<Tooltip title="More..." arrow>
							<IconButton edge="start" color="inherit" aria-label="web-app-info-spreader">
								<MoreVertIcon />
							</IconButton>
						</Tooltip>
					</Toolbar>
